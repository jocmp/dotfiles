...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; If nil, uses whatever the Emacs default is, otherwise a dirsectory path
...
(define-key global-map (kbd "M-B") 'treemacs)
(define-key global-map (kbd "C-i") 'lsp-format-buffer)
